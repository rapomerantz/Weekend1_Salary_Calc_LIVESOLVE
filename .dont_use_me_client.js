...
function addToTable (inputFirstName, inputLastName, inputIdNumber, inputJobTitle, inputAnnualSalary) {
  $('#tableInsert').empty();
  let removeButton = '<button type="button" class="removeButton" id="removeButton'+ rowCounter +'"> Remove Employee </button>';
  console.log(inputFirstName, inputLastName, inputIdNumber, inputJobTitle, inputAnnualSalary);
  $('#tableInsert').append('<tr id="row'+ rowCounter +'"><td>'+inputFirstName+'</td><td>'+inputLastName+'</td><td>'+inputIdNumber+'</td><td>'+inputJobTitle+'</td><td>'+inputAnnualSalary+'</td><td> ' + (inputAnnualSalary/12).toFixed() + '</td><td>'+ removeButton +'</td></tr>');
  rowCounter ++;
